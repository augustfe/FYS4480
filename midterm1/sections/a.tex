...
For the possible two-particle-two-hole (2p2h) excitations $\ket{\Phi_{ij}^{ab}}$, we have that both elevtrons below the Fermi level excite, and that the particles above the Fermi level have opposite spins.
